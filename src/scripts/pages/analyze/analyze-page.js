...
export default class AnalyzePage {
  ...
  _renderAnalyzeResult(result) {
    ...
    const resultContainer = document.getElementById("analysis-result");
    resultContainer.innerHTML = generateAnalyzeResultTemplate(
      type,
      description,
    );
  ...
  #bindCardBtnActions(callback) {
    ...
    const ResetBtn = document.getElementById("reset-btn");
    ResetBtn.addEventListener("click", (e) => this.#presenter._handleReset());
  }

  #bindResultBtnActions(callback) {
    const ShareBtn = document.getElementById("share-btn");
    ShareBtn.addEventListener("click", (e) => this.#presenter._handleShare());
